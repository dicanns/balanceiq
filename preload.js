...
contextBridge.exposeInMainWorld('api', {
  ...
  coa: {
    ...
    rename:               (id, names)    => ipcRenderer.invoke('coa:rename', id, names),
  },
  ledger: {
    entry: {
    ...
    depositPost:    (opts) => ipcRenderer.invoke('ledger:deposit:post', opts),
    depositApply:   (opts) => ipcRenderer.invoke('ledger:deposit:apply', opts),
    depositReverse: (opts) => ipcRenderer.invoke('ledger:deposit:reverse', opts),
  ...
  bank: {
    accounts: {
      ...
      needsCategorizing: ()   => ipcRenderer.invoke('bank:needsCategorizing'),
    },
    statement: {
  ...
  supplierBills: {
    ...
    setDocument:(id, docId)    => ipcRenderer.invoke('supplier:bill:setDocument', id, docId),
