...
export const FR = {
  ...
  checklistWarnRequired:  n => `⚠️ ${n} tâche${n>1?'s':''} requise${n>1?'s':''} non complétée${n>1?'s':''}`,
  ...
  checklistPrebuiltGeneric:   "⚙️ Générique",
  ...
  dailyLivMismatch: (pos,man)=>`⚠️ Livraisons POS (${pos}) ≠ Livraisons comptées (${man})`,
  dailyPmtMatch:    "✓ Le détail correspond au total terminal",
  dailyPmtMismatch: (det,ter,ecart)=>`⚠️ Le détail (${det}) ne correspond pas au terminal (${ter}) — écart de ${ecart}`,
  dailyPosTermMatch: "✓ Paiements POS et terminal balancés",
  dailyPosTermMismatch:(pos,ter,ecart)=>`⚠️ Total POS (${pos}) ≠ terminal (${ter}) — écart de ${ecart}`,
  dailyExpectedCash:"Encaisse attendue",
  dailyCashVarianceShort:(amt)=>`⚠️ Écart caisse: ${amt} (court)`,
  dailyCashVarianceOver: (amt)=>`⚠️ Écart caisse: ${amt} (excédent)`,
  ...
  extEventPlaceholder: "Saint-Jean-Baptiste, Ramadan, Festival, Match de hockey...",
...
export const EN = {
  ...
  checklistWarnRequired:  n => `⚠️ ${n} required task${n>1?'s':''} not completed`,
  ...
  checklistPrebuiltGeneric:   "⚙️ Generic",
  ...
  dailyLivMismatch: (pos,man)=>`⚠️ POS deliveries (${pos}) ≠ Counted deliveries (${man})`,
  dailyPmtMatch:    "✓ Breakdown matches terminal total",
  dailyPmtMismatch: (det,ter,ecart)=>`⚠️ Breakdown (${det}) doesn't match terminal (${ter}) — variance of ${ecart}`,
  dailyPosTermMatch: "✓ POS payments and terminal balanced",
  dailyPosTermMismatch:(pos,ter,ecart)=>`⚠️ POS total (${pos}) ≠ terminal (${ter}) — variance of ${ecart}`,
  dailyExpectedCash:"Expected cash",
  dailyCashVarianceShort:(amt)=>`⚠️ Cash variance: ${amt} (short)`,
  dailyCashVarianceOver: (amt)=>`⚠️ Cash variance: ${amt} (over)`,
  ...
  extEventPlaceholder: "St. Patrick's Day, Ramadan, Festival, Game night...",
