...
export const FR = {
  ...
  tipCOGS:              "Coût des marchandises et fournitures (avant taxes). Saisissez chaque facture fournisseur reçue dans le mois. Configurez vos fournisseurs dans Config → P&L & Fournisseurs.",
...
export const EN = {
  ...
  tipCOGS:              "Cost of goods and supplies (before taxes). Enter each supplier invoice received during the month. Set up your suppliers in Settings → P&L & Suppliers.",
