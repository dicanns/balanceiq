...
export const FR = {
 ...
 cfgAuditLog: "Journal d'audit",
  ...
  plBillsMoved: "Les factures fournisseurs se saisissent dans Factures, où elles passent au grand livre et à la déclaration de taxes.",
  plBillsGoTo: "Saisir dans Factures",
  cfgCloudPasswordConfirm: "Confirmer le mot de passe",
 ...
 posImportError: "Erreur d'importation POS",
  ...
  csvHasHeader:        "La première ligne contient les titres de colonnes",
  csvDateCol:          "Colonne date",
  csvAmountCol:        "Colonne montant",
  csvContinue:         "Continuer",
  csvInvalid:          "Fichier CSV invalide ou vide.",
  csvWrongColumns:     "Mauvaises colonnes?",
  csvRemembered:       (n) => `Ce mappage sera mémorisé pour ${n}.`,
  csvImportN:          (n) => `Importer ${n} dépôt${n!==1?"s":""}`,
 ...
 welcomeSubtitle2: "Comment utilisez-vous l'application?",
  ...
  prevImportHasHeader: "La première ligne contient les titres de colonnes",
...
export const EN = {
 ...
 plBillsMoved: "Supplier bills are recorded in Bills, where they reach the ledger and the GST/QST return.",
 plBillsGoTo: "Record in Bills",
 cfgCloudPasswordConfirm: "Confirm password",
 ...
 cfgCloudForgotHint: "Enter your email and we'll send you a link to reset your password.",
  ...
  csvHasHeader:        "The first line holds column titles",
  csvDateCol:          "Date column",
  csvAmountCol:        "Amount column",
  csvContinue:         "Continue",
  csvInvalid:          "Empty or unreadable CSV file.",
  csvWrongColumns:     "Wrong columns?",
  csvRemembered:       (n) => `This mapping will be remembered for ${n}.`,
  csvImportN:          (n) => `Import ${n} payout${n!==1?"s":""}`,
 ...
 flashReportHint: "Receive a morning email summary with yesterday's numbers.",
  ...
  prevImportHasHeader: "The first line holds column titles",
