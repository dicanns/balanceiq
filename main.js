...
const {
  ...
  stripApiConfigSecrets, mergeApiConfigSecrets, incomeStatement, coaSetItcPct,
...
ipcMain.handle('close:compliance:exceptionPatterns',  (_e, opts) => closeExceptionPatterns(opts || {}));
